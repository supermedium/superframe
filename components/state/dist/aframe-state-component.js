...
var _getPrototype = __webpack_require__(13);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(15);
...
function createStore() {
  ...
  // Create store
  return Redux.createStore(Redux.combineReducers(reducers), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
}
 ...
 */
var Reducer = function Reducer() {/* no-op */};
Reducer.prototype = {
  initialState: {},
  handlers: {}
};
...
AFRAME.registerReducer = function (name, definition) {
  ...
  if (REDUCERS[name]) {
    throw new Error('The reducer `' + name + '` has been already registered. ' + 'Check that you are not loading two versions of the same reducer ' + 'or two different reducers of the same name.');
  }
  ...
  NewReducer = function NewReducer() {
    Reducer.call(this);
  };
  ...
  NewReducer.prototype.reducer = function (state, payload) {
    ...
    if (!definition.handlers[payload.type]) {
      return state;
    }
...
AFRAME.registerComponent('bind', {
  ...
  onStateUpdate: function onStateUpdate() {
    ...
    if (_typeof(this.data) !== 'object') {
      ...
      if (value.constructor !== Object && value === this.lastData) {
        return;
      }
    ...
    for (propertyName in this.data) {
      ...
      if (value.constructor !== Object && this.lastData[propertyName] === value) {
        continue;
      }
...
var _getRawTag = __webpack_require__(11);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(12);
